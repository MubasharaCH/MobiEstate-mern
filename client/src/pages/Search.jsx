...
export const Search = () => {
  ...
  // console.log(listings)
   useEffect(()=>{
    ...
    if(searchTermFormUrl || typeFromUrl || parkingFromUrl || furnishedFromUrl ||offerFromUrl || sortFromUrl || orderFromUrl ){
      setSidebardata({
   ...
   const handleChange=(e)=>{
    ...
    const handleSubmit=(e)=>{
      ...
      urlParams.set('order',sidebardata.order)
       const  searchQury=urlParams.toString()
        navugate(`/search/?${searchQury}`)
    }
 const ShowMoreOnClick= async ()=>{
  ...
  return (
    <div className='flex flex-col md:flex-row'>
        ...
        {/* Left Side for define search terms*/}
            ...
            <form className='flex flex-col gap-8 ' onSubmit={handleSubmit}>
             <div className='flex items-center gap-2'>
              ...
              />
                ...
                <button className='bg-slate-700 p-3 rounded-lg text-white hover:opacity-95  uppercase'>Search</button>
            </form>
        </div>



     {/* Right side for listing search result*/}
        <div className="flex-1">
          ...
          onClick={ShowMoreOnClick}>Show more</button>
